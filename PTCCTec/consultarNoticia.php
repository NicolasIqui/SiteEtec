      ...
      <div class="container my-4">
          ...
          ?>
            <tr>
              ...
              <td>  <img src="<?php echo $row[5]   ?> " alt=""  width="35%"  >  </td>

              <td>
                <a href="excluirNoticia.php?id=<?php echo $row[0];  ?>">Excluir </a>
              </td>
              <td>
                <a href="AlterNoticia.php <?php echo "?id=$row[0]&Assunto=$row[1]&data=$row[2]&local=$row[3]&mensagem=$row[4]"; ?>  " >Alterar  </a>
              </td>
